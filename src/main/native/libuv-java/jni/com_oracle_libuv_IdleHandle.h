...
#include <jni.h>
/* Header for class com_oracle_libuv_IdleHandle */

#ifndef _Included_com_oracle_libuv_IdleHandle
#define _Included_com_oracle_libuv_IdleHandle
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_oracle_libuv_IdleHandle
 * Method:    _new
 * Signature: (J)J
 */
