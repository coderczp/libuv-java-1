...
#include <jni.h>
/* Header for class com_oracle_libuv_PipeHandle */

#ifndef _Included_com_oracle_libuv_PipeHandle
#define _Included_com_oracle_libuv_PipeHandle
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_oracle_libuv_PipeHandle
 * Method:    _new
 * Signature: (JZ)J
 */
