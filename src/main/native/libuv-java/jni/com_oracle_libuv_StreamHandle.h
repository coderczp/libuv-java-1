...
#include <jni.h>
/* Header for class com_oracle_libuv_StreamHandle */

#ifndef _Included_com_oracle_libuv_StreamHandle
#define _Included_com_oracle_libuv_StreamHandle
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_oracle_libuv_StreamHandle
...
JNIEXPORT jint JNICALL Java_com_oracle_libuv_StreamHandle__1writev
  (JNIEnv *, jobject, jlong, jobjectArray, jint, jobject);
