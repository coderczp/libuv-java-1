...
#include <jni.h>
/* Header for class com_oracle_libuv_TCPHandle */

#ifndef _Included_com_oracle_libuv_TCPHandle
#define _Included_com_oracle_libuv_TCPHandle
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_oracle_libuv_TCPHandle
 * Method:    _new
 * Signature: (J)J
 */
...
JNIEXPORT jint JNICALL Java_com_oracle_libuv_TCPHandle__1bind
  (JNIEnv *, jobject, jlong, jstring, jint, jboolean, jint);
